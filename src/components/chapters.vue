  ...
  <div style="margin-top: 7vh; padding: 0 2vw">
    ...
    <div v-else style="margin-top: 7vh; ">
      <div
        ...
        :key="chapter.id"
        :ref="'chapterRef' + index"
        class="chapter"
      >
        <div style="width: 100%;" @click="menu2(chapter.id)"><h2>{{ chapter.name }} ({{ chapter.transliteration }})</h2>
...
export default {
  ...
  axios
    ...
    save(i){
      this.duaIndex = i - 1;
      this.saved.push((this.chapters[duaIndex] ? this.chapters[this.duaIndex].verses : []))
      alert(this.saved);
    }
  },
